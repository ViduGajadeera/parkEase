...
<tr><td>
<div class="card">
  <div class="bg">Zone A <br> Available Slots <br><div class="vacant"><?php echo $rowA[0]; ?></div></div>
  <div class="blob"></div>
</div>
</td>
<td width="40px"></td>
...
<div class="card">
  <div class="bg">Zone B<br> Available Slots <br><div class="vacant"><?php echo $rowB[0]; ?></div></div>
  <div class="blob"></div>
</div>
</td>
<td width="40px"></td>
<td>
<div class="card">
  <div class="bg"> Zone C<br> Available Slots <br><div class="vacant"><?php echo $rowC[0]; ?></div></div>
  <div class="blob"></div>
</div>
</td>
<td width="40px"></td>
...
<div class="card">
  <div class="bg">Zone D<br> Available Slots <br><div class="vacant"><?php echo $rowD[0]; ?></div></div>
  <div class="blob"></div>
</div>
</td>
</tr>
