 ...
 include 'connection.php';   
  ...
  if (isset($_POST['sub'])) {
    ...
    if(preg_match("/^[0]{1}[7]{1}[01245678]{1}[0-9]{7}$/", $mobile)){
       $sqlp="SELECT * FROM staff_registration WHERE (emp_contat='$mobile')";
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_POSTFIELDS =>'{"messages":[{"destinations":[{"to":"+94'.$offtp.'"}],"from":"InfoSMS","text":"parkEase 1.0: \n'. 'Your OTP to reset your password is '.$otp.'"}]}',
...
$_SESSION['otp']=$otp;
$_SESSION['mobile']=$offtp;
header('location: Ootp.php');
...
?>
   ...
   <body>
      <div class="login-form">
         ...
         <form action="Oforgot.php" method="post">
            <div class="field">
